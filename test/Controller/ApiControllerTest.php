...
use OnePlace\Discipline\Controller\ApiController;
...
class ApiControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCannotBeAccessedWithoutKey() {
        $this->dispatch('/discipline/api', 'GET');
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/discipline/api?authkey=DEVRANDOMKEY', 'GET');
        ...
        $this->assertMatchedRouteName('discipline-api');
    }
}
