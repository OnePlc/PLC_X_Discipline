<?php
/**
 * DisciplineControllerTest.php - Main Controller Test Class
 *
 * Test Class for Main Controller of Discipline Module
 *
 * @category Test
 * @package Discipline
...
namespace OnePlaceTest\Discipline\Controller;

use OnePlace\Discipline\Controller\DisciplineController;
...
class DisciplineControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/discipline', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('discipline');
        $this->assertControllerName(DisciplineController::class); // as specified in router's controller name alias
        $this->assertControllerClass('DisciplineController');
        $this->assertMatchedRouteName('discipline');
    }
    ...
    public function testAddActionCanBeAccessed() {
        ...
        $this->dispatch('/discipline/add', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('discipline');
        $this->assertControllerName(DisciplineController::class); // as specified in router's controller name alias
        $this->assertControllerClass('DisciplineController');
    ...
    public function testEditActionCanBeAccessed() {
        ...
        $this->dispatch('/discipline/edit/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('discipline');
        $this->assertControllerName(DisciplineController::class); // as specified in router's controller name alias
        $this->assertControllerClass('DisciplineController');
    ...
    public function testViewActionCanBeAccessed() {
        ...
        $this->dispatch('/discipline/view/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('discipline');
        $this->assertControllerName(DisciplineController::class); // as specified in router's controller name alias
        $this->assertControllerClass('DisciplineController');
